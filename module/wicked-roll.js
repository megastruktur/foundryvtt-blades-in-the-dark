...
async function showChatRollMessage(r, zeromode, attribute_name = "", position = "", effect = "") {
  ...
  switch (effect) {
    ...
    let result = await renderTemplate("systems/wicked-ones/templates/blades-roll.html", {rolls: rolls, roll_status: roll_status, attribute_label: attribute_label, position: position, effect: effect_localize});
